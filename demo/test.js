...
// console.log(XHttpUtils.qsStringify({ start: 0, count: 20, obj: { a: 1 }, arr: [1, 2, 3] })); // start=0&count=20&obj={"a":1}&arr=1,2,3
...
// console.log(XHttpUtils.objByData([{ a: 1, b: 2 }, { a: 3 }, { b: 1 }, { c: 1 }], 'a')); // { '1': { a: 1, b: 2 }, '3': { a: 3 }, undefined: { c: 1 } }
// console.log(XHttpUtils.objByData([{ a: 1, b: 'b1' }, { a: 3 }, { a: 2, b: 'b2' }], 'a', 'b')); // { '1': 'b1', '2': 'b2', '3': undefined }
// console.log(XHttpUtils.arrByData([{ a: 1, b: 2 }, { a: 3 }, { b: 1 }], 'a')); // [ 1, 3 ]
...
// console.log(XHttpUtils.getFirstVar([1, 2])); // 1
// console.log(XHttpUtils.getFirstVar({ a: 2, b: 1 })); // 2
